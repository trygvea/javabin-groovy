...
import sudoku.Board;
import sudoku.JavaSolver;


class JavaSolverTests {
    
    def solver = new JavaSolver()
    ...
    void "should solve real hard sudoku"() {
        ...
        def realHardProblem =  new Board('  3      4   8  36  8   1   4  6  73   9          2  5  4 7  686        7  6  5  ')
        def expectedSolution = new Board('123456789457189236968327154249561873576938412831742695314275968695814327782693541')
